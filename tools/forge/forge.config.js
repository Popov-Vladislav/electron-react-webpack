...
module.exports = {
	...
	packagerConfig: {
		...
		asar: true,
		// Set executable name
		executableName: 'Electron learn',
		// Set application copyright
		appCopyright: 'Copyright (C) VPopopv',
	...
	plugins: [
		{
			...
			config: {
				...
				devContentSecurityPolicy:
					'default-src "self" "unsafe-inline" data:; script-src "self" "unsafe-inline" data:; script-src-elem * "unsafe-inline" data:',
				// Ports
				port: 3000, // Webpack Dev Server port
				loggerPort: 9000, // Logger port
				// Main process webpack configuration
				mainConfig: path.join(rootDir, 'tools/webpack/webpack.electron.main.js'),
				// Renderer process webpack configuration
				renderer: {
					// Configuration file path
					config: path.join(rootDir, 'tools/webpack/webpack.electron.renderer.js'),
					...
					entryPoints: [
						{
							...
							html: path.join(rootDir, 'tools/templates/index.html'),
							// Renderer
